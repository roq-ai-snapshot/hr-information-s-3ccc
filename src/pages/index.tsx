  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Information System - Your one-stop solution for efficient employee data management, streamlined vacation tracking, and seamless payroll processing."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Information System - Your one-stop solution for efficient employee data management, streamlined vacation tracking, and seamless payroll processing.`}
            </Text>
            <Box
